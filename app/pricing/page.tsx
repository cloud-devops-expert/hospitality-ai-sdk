...
} from '@/lib/pricing/ml-regression';
    ...
    switch (algo) {
      case 'traditional':
        return {
          ...
          latency: '~5ms',
          accuracy: '75% R²',
          description: 'Multi-factor formula',
        };
      case 'linear-regression':
                ...
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    ...
                    <div className="bg-gray-50 dark:bg-gray-900 p-3 rounded">
                      ...
                      <p
                        className={`font-semibold ${getAdjustmentColor(
                  ...
                  <div className="text-sm text-gray-700 dark:text-gray-300 space-y-2">
                    {result.finalPrice > result.originalPrice * 1.2 ? (
                      <p className="bg-orange-50 dark:bg-orange-900/20 border border-orange-200 dark:border-orange-800 rounded p-3">
                        <strong>High Demand Period:</strong> Consider offering value-added services
                      ...
                      <p className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded p-3">
                        <strong>Low Demand Period:</strong> Good time for promotions and package
                        deals to drive bookings.
                      </p>
                    ) : (
                      <p className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded p-3">
                        <strong>Optimal Pricing:</strong> Price is well-balanced for current market
                        conditions.
                      </p>
                    )}
                  </div>
